...
function Desk(props) {
    ...
    const changeStatus = async (event) => {
        ...
        let res = await authApi().patch((endpoints['changeStatusShip'])(props.orderid), {
        })
        { nav(`/homepage`) }
        ...
        return (
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><Button size="sm" variant="success " style={{ width: "100px", margin: '0', }} onClick={changeStatus} >Đã Giao</Button> </td>
                </tr>
